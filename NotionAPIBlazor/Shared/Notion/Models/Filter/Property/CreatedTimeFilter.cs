...
{
    public class CreatedTimeFilter : PropertyFilter
    {
            ...
            object next_year = null)
        {
            ...
            CreatedTime = new DateCondition(equals, before, after, on_or_before, is_empty, is_not_empty, on_or_after,
                past_week, past_month, past_year, this_week, next_week, next_month, next_year);
        }

        [JsonProperty("created_time")]
        public DateCondition CreatedTime { get; set; }
    }
}
